...
var langs = {
    "ru": {
        ...
        "about_us_text2": "Мультиконт Одесса имеет большие возможности предоставления морских логистических и экспедиторских услуг на территории Одесского, Черноморского, Южного портов, благодаря удобному расположению в Одессе и заключенным договорам с ними. Квалифицированный персонал компании в любой момент готов Вас персонально проконсультировать относительно вопросов: организации доставки груза, морских контейнерных перевозок, таможенного оформления (застаможки) Вашего груза, составить оптимальный логистический план с предварительными просчетами для каждого персонального клиента. Мы ценим своих клиентов и предоставляем услуги качественно и точно в срок. В работе с клиентами Мы всегда стремимся долгосрочному и взаимовыгодному сотрудничеству, предлагаем решения самых сложных задач в сфере организации доставки грузов.",
    ...
    "en": {
        ...
        "we_are_the_members_of_aifu_and_fiata": "",
        "we_have_received_recognition_and_cultivate_new_successes": "",
        "our_partners_is_the_key_of_our_success": "",
        "llc_vob": "",
        "llc_yuval_trade": "",
        "we_always_together_with": "",
